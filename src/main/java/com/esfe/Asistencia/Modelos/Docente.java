...
public class Docente {
    ...
    @NotBlank(message = "El apellido del docente es requerido")
    private String apellido;

    @NotBlank(message = "El email del docente es requerido")
    @Email(message = "La entrada no corresponde a un email válido")
    private String email;

    @NotBlank(message = "El teléfono del docente es requerido")
